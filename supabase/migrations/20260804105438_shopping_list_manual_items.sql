-- Slice 6 (CP2) — manual items survive regeneration.
-- Ad-hoc items the shopper adds by hand ("paper towels") must not be wiped when
-- the list is regenerated from the plan. Flag them and skip them on regenerate.
